...
public class TodoServiceImpl implements TodoService{
    ...
    public TodoResponse createTodo(TodoRequest todoRequest) {
        ...
        return convertToTodoResponse(saved);
    }
    ...
    public TodoResponse toggleTodoCompletion(long id) {
        ...
        Todo updated = todoRepository.save(todo.get());

        return convertToTodoResponse(updated);
    }
    ...
    private TodoResponse convertToTodoResponse(Todo t){
        return new TodoResponse(t.getId(), t.getTitle(), t.getDescription(), t.getPriority(), t.isComplete());
    }
}
